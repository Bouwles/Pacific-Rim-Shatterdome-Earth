...
const KAIJU: readonly KaijuDefinition[] = [
  ...
  },
  {
    ...
    zones: [
      ...
      zone("limb.left", "Left arm", 0.58, 4, -16, 9, 3_200, 0.4, 0.85, "cripple-attack", "Heavy strike arm."),
      zone(
        "limb.right",
        "Right arm",
        0.58,
      ...
      zone(
        ...
        0.8,
        "cripple-movement",
        "Plated thigh; slower pivots without it.",
      ),
      zone(
        "leg.right",
        "Right leg",
