...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    strafeSpeedMps: 9.3,
    guardSpeedMps: 7.6,
    accelerationMps2: 14.3,
    brakingMps2: 18.4,
    turnRateDegPerSecond: 88.4,
    turnInPlaceRateDegPerSecond: 134.4,
    stepUpMeters: 9,
    maxSlopeDeg: 38,
    strideMeters: 27,
...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    strafeSpeedMps: 6.4,
    guardSpeedMps: 6.1,
    accelerationMps2: 8.8,
    brakingMps2: 12.8,
    turnRateDegPerSecond: 57.8,
    turnInPlaceRateDegPerSecond: 92.8,
    stepUpMeters: 11,
    maxSlopeDeg: 33,
    strideMeters: 30,
    boosterImpulseMps: 8,
...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    strafeSpeedMps: 14,
    guardSpeedMps: 10.9,
    accelerationMps2: 23.5,
    brakingMps2: 27.2,
    turnRateDegPerSecond: 129.2,
    turnInPlaceRateDegPerSecond: 204.8,
    stepUpMeters: 8,
    maxSlopeDeg: 44,
    strideMeters: 22,
...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    strafeSpeedMps: 6.8,
    guardSpeedMps: 6.1,
    accelerationMps2: 10.1,
    brakingMps2: 14.4,
    turnRateDegPerSecond: 61.2,
    turnInPlaceRateDegPerSecond: 96,
    stepUpMeters: 8,
    maxSlopeDeg: 34,
    strideMeters: 25,
    boosterImpulseMps: 7,
...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    accelerationMps2: 13,
    brakingMps2: 16.8,
    turnRateDegPerSecond: 78.2,
    turnInPlaceRateDegPerSecond: 121.6,
    stepUpMeters: 9,
    maxSlopeDeg: 37,
    strideMeters: 26,
    boosterImpulseMps: 9,
...
jaegerRegistry.register({
  ...
  locomotion: {
    ...
    strafeSpeedMps: 7.2,
    guardSpeedMps: 6.4,
    accelerationMps2: 9.2,
    brakingMps2: 13.6,
    turnRateDegPerSecond: 54.4,
    turnInPlaceRateDegPerSecond: 86.4,
    stepUpMeters: 11,
    maxSlopeDeg: 32,
    strideMeters: 31,
    boosterImpulseMps: 6,
